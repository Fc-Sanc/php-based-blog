...
{
    // Get the domain-relative URL (e.g. /blog/whatever.php or /whatever.php) 
    // and work out the folder (e.g. /blog or /).
    // strrpos() : find last position of second parameter (start with 0)
 ...
 * @return array
 */
function getCommentsForPost(PDO $pdo, $post_id)
{
 ...
 * has prepared for him/her (e.g. on a public computer) the cracker's copy of the cookie ID will be useless
 *
